 ...
 *
 * All times stated in comments use the shop timezone (SBT = Pacific/Guadalcanal
 * = UTC+11).  Mapping for the test date 2026-08-10 (Monday):
 *
 ...
 * 2026-08-09 00:00 UTC = Sunday Aug 9 11:00 SBT (the day before the test date)
 */
...
describe("getAvailableSlots", () => {
  ...
  it("excludeBookingId lets a booking's own slot stay available while rescheduling", async () => {
    ...
    expect(withExclude).toContain("2026-08-09T22:00:00.000Z") // 09:00 SBT, now free
  })
})
